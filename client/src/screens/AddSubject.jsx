...
const AddSubject = () => {
  ...
  const clickHandler = async () => {
    ...
    const response = await fetch("api/v1/customer/12345/admin/subject/add", {
      method: "PUT",
      headers: {
      ...
      body: JSON.stringify({
        ...
        subjectID: subId,
        subjectName: cname,
        subjectDescription: cDescription,
      }),
    });
      ...
      <div className="add-course-container">
        <div>
          ...
          <div className="form-container">
            ...
            <div className="input-field-container">
              <h2 className="course-label">Subject Name : </h2>
              <input
                type="text"
            ...
            <div className="input-field-container">
              <h2 className="course-label">Subject Description : </h2>
              <textarea
                type="text"
