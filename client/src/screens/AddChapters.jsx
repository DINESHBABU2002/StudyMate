...
const AddChapters = () => {
  ...
  const clickHandler = async () => {
    console.log({ sid }, { coid }, { subId }, { cid });
    setIsPopup(false);
    setMessage({ type: "", message: "", color: "" });
    const response = await fetch("api/v1/customer/12345/admin/chapter/add", {
      method: "PUT",
      headers: {
      ...
      <div className="add-course-container">
        <div>
          ...
          <div className="form-container">
            ...
            <div className="input-field-container">
              <h2 className="course-label">Chapter Name : </h2>
              <input
                type="text"
            ...
            <div className="input-field-container">
              <h2 className="course-label">Chapter Description : </h2>
              <textarea
                type="text"
